...
colors:
  ...
  text-muted: "#087cff"
  text-light: "#9A9A9A"
  accent-light: "rgba(8, 124, 255, 0.08)"
  accent-medium: "rgba(8, 124, 255, 0.15)"
  border: "rgba(8, 124, 255, 0.2)"
  card-bg: "rgba(8, 124, 255, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  ...
  tag:     { fontFamily: "Arial", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "Arial", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Arial, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Arial", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Arial", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Arial", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
