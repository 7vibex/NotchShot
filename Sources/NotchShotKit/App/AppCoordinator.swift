...
///
/// Decomposition boundaries (see Documentation/ARCHITECTURE.md):
/// shelf models live in ShelfItem.swift, recording thumbnails in
/// VideoThumbnail.swift. Capture, recording, shelf, intelligence, and
/// productivity/context remain behind this facade until each pipeline
/// controller is extracted behind a narrow push/history/activity interface.
@MainActor
@Observable
